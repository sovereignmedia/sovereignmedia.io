        ...
        {pricing.invoiceUrl && (
          <div className="mt-8 flex justify-end">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-md bg-accent-blue px-5 py-2.5 font-mono text-sm font-medium text-white transition-all duration-300 hover:bg-accent-blue/85 hover:shadow-[0_0_20px_rgba(249,115,22,0.25)]"
            >
              View Invoice
              <ArrowRight size={14} />
            </a>
